        ...
        @foreach ($news as $item)
          <div class="flex flex-col border border-gray-300">
            ...
            <div class="flex-1 p-6 flex flex-col gap-6">
              ...
              <a href="{{ route('news.article', $item->id) }}">
                <button type="button"
                  class="w-fit relative group inline-flex justify-center items-center gap-2 whitespace-nowrap border border-slate-900 px-5.5 py-3.5 tracking-wide transition-colors text-center cursor-pointer">
