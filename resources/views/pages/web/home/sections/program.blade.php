<section class="max-w-7xl mx-auto">
  <div class="mx-6 space-y-8">
    <div class="flex items-center justify-between">
      <div class="space-y-2">
        <div class="flex items-center gap-4">
          ...
          <h1 class="font-semibold text-xl text-blue-600">ACADEMICS</h1>
        </div>
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
      <a href="" class="group border border-gray-300 p-6 space-y-6">
        ...
        <button type="button"
          class="w-full relative inline-flex justify-center items-center gap-2 whitespace-nowrap border border-slate-900 px-5.5 py-3.5 tracking-wide transition-colors text-center cursor-pointer">
          <span class="relative z-10 transition-colors duration-300 group-hover:text-white">
            Discover
          </span>
          <i data-lucide="move-right" stroke-width="1.5"
